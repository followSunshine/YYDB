...
//    iv.image = [UIImage imageNamed:@"Screen.png"];
    monitor.conn = nil;
    [monitor.imgData setLength:0];
    iv.contentMode = UIViewContentModeScaleAspectFill;
    iv.clipsToBounds = YES;
    [v addSubview:iv];
    [iv sd_setImageWithURL:[NSURL URLWithString:@"https://s3.vbokai.com/shanp/1.7/index.png"] placeholderImage:[UIImage imageNamed:@"闪屏.png"]];
...
//    [v addSubview:label];
    ...
    __block NSInteger btntime = 4; //倒计时时间
    ...
    dispatch_source_set_event_handler(_timer, ^{
        ...
        if(btntime <= 0){ //倒计时结束，关闭
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                [showDetailBtn setTitle:[NSString stringWithFormat:@"%ldS",(long)btntime] forState:UIControlStateNormal];
            });
